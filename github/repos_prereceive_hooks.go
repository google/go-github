...
//
// GitHub API docs: https://docs.github.com/enterprise-server@3.22/rest/enterprise-admin/repo-pre-receive-hooks#list-pre-receive-hooks-for-a-repository
//
...
//
// GitHub API docs: https://docs.github.com/enterprise-server@3.22/rest/enterprise-admin/repo-pre-receive-hooks#get-a-pre-receive-hook-for-a-repository
//
...
//
// GitHub API docs: https://docs.github.com/enterprise-server@3.22/rest/enterprise-admin/repo-pre-receive-hooks#update-pre-receive-hook-enforcement-for-a-repository
//
...
//
// GitHub API docs: https://docs.github.com/enterprise-server@3.22/rest/enterprise-admin/repo-pre-receive-hooks#remove-pre-receive-hook-enforcement-for-a-repository
//
