...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/migrations/users/#start-a-user-migration
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/migrations/users/#list-user-migrations
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/migrations/users/#get-a-user-migration-status
...
// id is the migration ID.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/migrations/users/#download-a-user-migration-archive
...
// id is the migration ID.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/migrations/users/#delete-a-user-migration-archive
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/migrations/users/#unlock-a-user-repository
