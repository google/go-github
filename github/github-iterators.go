...
func (s *UsersService) ListPackageVersionsIter(ctx context.Context, packageType string, packageName string, opts *PackageVersionListOptions) iter.Seq2[*PackageVersion, error] {
