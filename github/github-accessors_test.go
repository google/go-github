...
func TestCodespaceMachine_GetCPUs(tt *testing.T) {
	tt.Parallel()
	var zeroValue int
	c := &CodespaceMachine{CPUs: &zeroValue}
	c.GetCPUs()
	c = &CodespaceMachine{}
	c.GetCPUs()
	c = nil
...
func TestCodespaceMachine_GetDisplayName(tt *testing.T) {
	tt.Parallel()
	var zeroValue string
	c := &CodespaceMachine{DisplayName: &zeroValue}
	c.GetDisplayName()
	c = &CodespaceMachine{}
	c.GetDisplayName()
	c = nil
...
func TestCodespaceMachine_GetMemoryInBytes(tt *testing.T) {
	tt.Parallel()
	var zeroValue int64
	c := &CodespaceMachine{MemoryInBytes: &zeroValue}
	c.GetMemoryInBytes()
	c = &CodespaceMachine{}
	c.GetMemoryInBytes()
	c = nil
...
func TestCodespaceMachine_GetName(tt *testing.T) {
	tt.Parallel()
	var zeroValue string
	c := &CodespaceMachine{Name: &zeroValue}
	c.GetName()
	c = &CodespaceMachine{}
	c.GetName()
	c = nil
...
func TestCodespaceMachine_GetOperatingSystem(tt *testing.T) {
	tt.Parallel()
	var zeroValue string
	c := &CodespaceMachine{OperatingSystem: &zeroValue}
...
func TestCodespaceMachine_GetPrebuildAvailability(tt *testing.T) {
	tt.Parallel()
	var zeroValue string
	c := &CodespaceMachine{PrebuildAvailability: &zeroValue}
...
func TestCodespaceMachine_GetStorageInBytes(tt *testing.T) {
	tt.Parallel()
	var zeroValue int64
	c := &CodespaceMachine{StorageInBytes: &zeroValue}
	c.GetStorageInBytes()
	c = &CodespaceMachine{}
	c.GetStorageInBytes()
	c = nil
