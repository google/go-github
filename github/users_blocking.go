...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#list-users-blocked-by-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#check-if-a-user-is-blocked-by-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#block-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#unblock-a-user
