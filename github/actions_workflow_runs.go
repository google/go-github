...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#list-workflow-runs
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#list-workflow-runs-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#get-a-workflow-run
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#re-run-a-workflow
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#cancel-a-workflow-run
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#download-workflow-run-logs
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#delete-workflow-run-logs
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/workflow-runs/#get-workflow-run-usage
