...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#list-self-hosted-runner-groups-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#get-a-self-hosted-runner-group-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#delete-a-self-hosted-runner-group-from-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#create-a-self-hosted-runner-group-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#update-a-self-hosted-runner-group-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#list-repository-access-to-a-self-hosted-runner-group-in-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#set-repository-access-for-a-self-hosted-runner-group-in-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#add-repository-access-to-a-self-hosted-runner-group-in-an-organization
...
// The runner group must have visibility set to 'selected'.
//
// GitHub API docs: https://docs.github.com/en/rest/actions#remove-repository-access-to-a-self-hosted-runner-group-in-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#list-self-hosted-runners-in-a-group-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#set-self-hosted-runners-in-a-group-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#add-a-self-hosted-runner-to-a-group-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions#remove-a-self-hosted-runner-from-a-group-for-an-organization
