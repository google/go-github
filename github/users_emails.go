...
//
// GitHub API docs: https://docs.github.com/en/rest/users/users#list-email-addresses-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/users/users#add-an-email-address-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/users/users#delete-an-email-address-for-the-authenticated-user
