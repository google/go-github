...
//
// GitHub API docs: https://docs.github.com/en/rest/users/#list-email-addresses-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/users/#add-an-email-address-for-the-authenticated-user
