...
func TestTeamsService_ListDiscussionsByName(t *testing.T) {
	client, mux, _, teardown := setup()
	defer teardown()
	...
	discussions, _, err := client.Teams.ListDiscussionsByName(context.Background(), "o", "s", &DiscussionListOptions{"desc"})
	if err != nil {
		t.Errorf("Teams.ListDiscussionsByName returned error: %v", err)
	}
	...
	if !reflect.DeepEqual(discussions, want) {
		t.Errorf("Teams.ListDiscussionsByName returned %+v, want %+v", discussions, want)
	}
}
...
func TestTeamsService_GetDiscussionByName(t *testing.T) {
	client, mux, _, teardown := setup()
	defer teardown()
	...
	discussion, _, err := client.Teams.GetDiscussionByName(context.Background(), "o", "s", 3)
	if err != nil {
		t.Errorf("Teams.GetDiscussionByName returned error: %v", err)
	}

	want := &TeamDiscussion{Number: Int(3)}
	if !reflect.DeepEqual(discussion, want) {
		t.Errorf("Teams.GetDiscussionByName returned %+v, want %+v", discussion, want)
	}
}
...
func TestTeamsService_CreateDiscussionByName(t *testing.T) {
	client, mux, _, teardown := setup()
	defer teardown()
	...
	comment, _, err := client.Teams.CreateDiscussionByName(context.Background(), "o", "s", input)
	if err != nil {
		t.Errorf("Teams.CreateDiscussionByName returned error: %v", err)
	}

	want := &TeamDiscussion{Number: Int(3)}
	if !reflect.DeepEqual(comment, want) {
		t.Errorf("Teams.CreateDiscussionByName returned %+v, want %+v", comment, want)
	}
}
...
func TestTeamsService_EditDiscussionByName(t *testing.T) {
	client, mux, _, teardown := setup()
	defer teardown()
	...
	comment, _, err := client.Teams.EditDiscussionByName(context.Background(), "o", "s", 3, input)
	if err != nil {
...
func TestTeamsService_DeleteDiscussionByName(t *testing.T) {
	client, mux, _, teardown := setup()
	defer teardown()
	...
	_, err := client.Teams.DeleteDiscussionByName(context.Background(), "o", "s", 3)
	if err != nil {
		t.Errorf("Teams.DeleteDiscussionByName returned error: %v", err)
	}
}
