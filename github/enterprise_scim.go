...
type SCIMEnterpriseGroupAttributes struct {
	DisplayName string                            `json:"displayName"`       // Human-readable name for a group.
	...
	ExternalID  string                            `json:"externalId"`        // This identifier is generated by a SCIM provider. Must be unique per group.
