...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#list-runner-applications-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#create-a-registration-token-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#list-self-hosted-runners-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#get-a-self-hosted-runner-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#create-a-remove-token-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#delete-a-self-hosted-runner-from-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#list-runner-applications-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#create-a-registration-token-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#list-self-hosted-runners-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#get-a-self-hosted-runner-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#create-a-remove-token-for-an-organization
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/self-hosted-runners/#delete-a-self-hosted-runner-from-an-organization
