	...
	want := []*ContributorStats{
		{
			...
			Weeks: []*WeeklyStats{
				{
					Week:      &Timestamp{time.Date(2013, time.May, 0o5, 0o0, 0o0, 0o0, 0, time.UTC).Local()},
					Additions: Int(6898),
					Deletions: Int(77),
					Commits:   Int(10),
				},
	...
	want := []*WeeklyCommitActivity{
		{
			...
			Total: Int(89),
			Week:  &Timestamp{time.Date(2012, time.May, 0o6, 0o5, 0o0, 0o0, 0, time.UTC).Local()},
		},
	}
...
func TestRepositoriesService_ListCodeFrequency(t *testing.T) {
	...
	want := []*WeeklyStats{{
		Week:      &Timestamp{time.Date(2011, time.April, 17, 0o0, 0o0, 0o0, 0, time.UTC).Local()},
		Additions: Int(1124),
		Deletions: Int(-435),
	}}
