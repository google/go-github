...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/#get-all-contributor-commit-activity
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/#get-the-last-year-of-commit-activity
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/#get-the-weekly-commit-activity
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/#get-the-weekly-commit-count
...
// delay of a second or so, should result in a successful request.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/#get-the-hourly-commit-count-for-each-day
