	...
	want := []*PersonalAccessToken{
		{
			...
			RepositorySelection: new("all"),
			RepositoriesURL:     new("https://api.github.com/organizations/652551/personal-access-tokens/25381/repositories"),
