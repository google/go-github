...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#list-followers-of-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#list-followers-of-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#list-the-people-the-authenticated-user-follows
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#list-the-people-a-user-follows
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#check-if-a-person-is-followed-by-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#check-if-a-user-follows-another-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#follow-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#unfollow-a-user
