...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#list-followers-of-a-user
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#list-followers-of-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#list-the-people-the-authenticated-user-follows
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#list-the-people-a-user-follows
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#check-if-a-person-is-followed-by-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#check-if-a-user-follows-another-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#follow-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/followers/#unfollow-a-user
