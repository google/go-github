...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#list-followers-of-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#list-followers-of-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#list-the-people-the-authenticated-user-follows
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#list-the-people-a-user-follows
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#check-if-a-person-is-followed-by-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#check-if-a-user-follows-another-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#follow-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/#unfollow-a-user
