...
// GetEnterpriseMetricsReport1Day gets a report containing Copilot metrics for a single day for an enterprise.
//
...
func (s *CopilotService) GetEnterpriseMetricsReport1Day(ctx context.Context, enterprise string, opts *CopilotMetricsReportOptions) (*CopilotMetricsReportResponse, *Response, error) {
	...
	var report *CopilotMetricsReportResponse
...
// GetEnterpriseMetricsReport28Day gets a report containing Copilot metrics for a 28-day rolling window for an enterprise.
//
...
func (s *CopilotService) GetEnterpriseMetricsReport28Day(ctx context.Context, enterprise string) (*CopilotMetricsReportResponse, *Response, error) {
...
// GetEnterpriseMetricsReportUsers1Day gets a report containing Copilot user metrics for a single day for an enterprise.
//
...
func (s *CopilotService) GetEnterpriseMetricsReportUsers1Day(ctx context.Context, enterprise string, opts *CopilotMetricsReportOptions) (*CopilotMetricsReportResponse, *Response, error) {
...
// GetEnterpriseMetricsReportUsers28Day gets a report containing Copilot user metrics for a 28-day rolling window for an enterprise.
//
...
func (s *CopilotService) GetEnterpriseMetricsReportUsers28Day(ctx context.Context, enterprise string) (*CopilotMetricsReportResponse, *Response, error) {
...
// GetOrganizationMetricsReport1Day gets a report containing Copilot metrics for a single day for an organization.
//
...
func (s *CopilotService) GetOrganizationMetricsReport1Day(ctx context.Context, org string, opts *CopilotMetricsReportOptions) (*CopilotMetricsReportResponse, *Response, error) {
...
func (s *CopilotService) GetOrganizationMetricsReport28Day(ctx context.Context, org string) (*CopilotMetricsReportResponse, *Response, error) {
...
// GetOrganizationMetricsReportUsers1Day gets a report containing Copilot user metrics for a single day for an organization.
//
...
func (s *CopilotService) GetOrganizationMetricsReportUsers1Day(ctx context.Context, org string, opts *CopilotMetricsReportOptions) (*CopilotMetricsReportResponse, *Response, error) {
...
// GetOrganizationMetricsReportUsers28Day gets a report containing Copilot user metrics for a 28-day rolling window for an organization.
//
...
func (s *CopilotService) GetOrganizationMetricsReportUsers28Day(ctx context.Context, org string) (*CopilotMetricsReportResponse, *Response, error) {
