...
// repositories.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#list-user-account-issues-assigned-to-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#list-issues-assigned-to-the-authenticated-user
...
// authenticated user.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#list-organization-issues-assigned-to-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#list-repository-issues
...
// Get a single issue.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#get-an-issue
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#create-an-issue
...
// Edit an issue.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#update-an-issue
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#lock-an-issue
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/issues/milestones/#unlock-an-issue
