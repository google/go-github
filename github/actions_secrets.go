...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#get-a-repository-public-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#get-an-organization-public-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#list-repository-secrets
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#get-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#create-or-update-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#delete-a-repository-secret
...
// without revealing their encrypted values.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#list-organization-secrets
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#get-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#create-or-update-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#list-selected-repositories-for-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#set-selected-repositories-for-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#add-selected-repository-to-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#remove-selected-repository-from-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/actions/secrets/#delete-an-organization-secret
