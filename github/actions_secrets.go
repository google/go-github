...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#get-a-repository-public-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#get-an-organization-public-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#list-repository-secrets
...
// without revealing their encrypted values.
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#list-organization-secrets
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#get-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#get-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#create-or-update-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#create-or-update-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#delete-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#delete-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#list-selected-repositories-for-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#set-selected-repositories-for-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#add-selected-repository-to-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/actions/#remove-selected-repository-from-an-organization-secret
