...
func TestGistsService_ListComments(t *testing.T) {
	...
	mux.HandleFunc("/gists/g/comments", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, "GET")
		fmt.Fprint(w, `[{"id": 1}]`)
	})

	comments, _, err := client.Gists.ListComments("g")
...
func TestGistsService_GetComment(t *testing.T) {
	...
	mux.HandleFunc("/gists/g/comments/1", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, "GET")
		fmt.Fprint(w, `{"id": 1}`)
	})

	comment, _, err := client.Gists.GetComment("g", 1)
...
func TestGistsService_CreateComment(t *testing.T) {
	...
	mux.HandleFunc("/gists/g/comments", func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprint(w,
			`
			{
				"id": 1,
				"body": "This is the comment body.",
				"url": "https://api.github.com/gists/g/comments/1",
				"user": {
					"login": "octocat",
					"id": 1,
	...
	comment, _, err := client.Gists.CreateComment("g", input)
	if err != nil {
...
func TestGistsService_EditComment(t *testing.T) {
	...
	comment, _, err := client.Gists.EditComment("g", 1, input)
	if err != nil {
...
func TestGistsService_DeleteComment(t *testing.T) {
	...
	_, err := client.Gists.DeleteComment("g", 1)
	if err != nil {
