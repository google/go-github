...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-repositories-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-repositories-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-organization-repositories
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-public-repositories
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#create-a-repository-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/repos/#create-an-organization-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#create-a-repository-using-a-template
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/codes-of-conduct/#get-the-code-of-conduct-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#update-a-repository
...
// Delete a repository.
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#delete-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#check-if-vulnerability-alerts-are-enabled-for-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#enable-vulnerability-alerts
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#disable-vulnerability-alerts
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#enable-automated-security-fixes
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#disable-automated-security-fixes
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-repository-contributors
...
//     }
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-repository-languages
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-repository-teams
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-repository-tags
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#list-branches
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-a-branch
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-status-checks-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-all-status-check-contexts
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#update-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#delete-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-commit-signature-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#create-commit-signature-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#delete-commit-signature-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#update-status-check-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos#remove-status-check-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-pull-request-review-protection
...
// It requires admin access and branch protection to be enabled.
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#update-pull-request-review-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#delete-pull-request-review-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-admin-branch-protection
...
// It requires admin access and branch protection to be enabled.
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#set-admin-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#delete-admin-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-all-repository-topics
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#replace-all-repository-topics
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#get-apps-with-access-to-the-protected-branch
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#set-app-access-restrictions
...
// Note: The list of users, apps, and teams in total is limited to 100 items.
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#add-app-access-restrictions
...
// Note: The list of users, apps, and teams in total is limited to 100 items.
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#remove-app-access-restrictions
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#transfer-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos/#create-a-repository-dispatch-event
