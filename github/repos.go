...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#list-branches
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#get-a-branch
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#get-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#get-status-checks-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#get-all-status-check-contexts
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#update-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#delete-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#get-commit-signature-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#create-commit-signature-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#delete-commit-signature-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#update-status-check-potection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#get-pull-request-review-protection
...
// It requires admin access and branch protection to be enabled.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#update-pull-request-review-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#delete-pull-request-review-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#get-admin-branch-protection
...
// It requires admin access and branch protection to be enabled.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#set-admin-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#delete-admin-branch-protection
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#list-apps-with-access-to-the-protected-branch
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#set-app-access-restrictions
...
// Note: The list of users, apps, and teams in total is limited to 100 items.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#add-app-access-restrictions
...
// Note: The list of users, apps, and teams in total is limited to 100 items.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/repos/branches/#remove-app-access-restrictions
