...
func TestSearchOptions_addOptions(t *testing.T) {
	url := "some/path"

	testAddURLOptions(t, url, &SearchOptions{}, url)
	...
	testAddURLOptions(t, url, u, url+`?order=asc&page=1&per_page=10&sort=author-date`)
}
