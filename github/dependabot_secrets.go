...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#get-a-repository-public-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#get-an-organization-public-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#list-repository-secrets
...
// without revealing their encrypted values.
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#list-organization-secrets
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#get-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#get-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#create-or-update-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#create-or-update-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#delete-a-repository-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#delete-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#list-selected-repositories-for-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#set-selected-repositories-for-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#add-selected-repository-to-an-organization-secret
...
//
// GitHub API docs: https://docs.github.com/en/rest/dependabot#remove-selected-repository-from-an-organization-secret
