...
//
// GitHub API docs: https://docs.github.com/en/rest/repos#list-all-autolinks-of-a-repository
...
//
// GitHub API docs: https://docs.github.com/en/rest/repos#create-an-autolink-reference-for-a-repository
...
// Information about autolinks are only available to repository administrators.
//
// GitHub API docs: https://docs.github.com/en/rest/repos#get-an-autolink-reference-of-a-repository
...
// Information about autolinks are only available to repository administrators.
//
// GitHub API docs: https://docs.github.com/en/rest/repos#delete-an-autolink-reference-from-a-repository
