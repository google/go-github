...
//
// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/apps#get-a-webhook-configuration-for-an-app
...
// The underlying transport must be authenticated as an app.
//
// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/apps#update-a-webhook-configuration-for-an-app
