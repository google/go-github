...
type RateLimits struct {
	...
	//
	// GitHub API docs: https://docs.github.com/rest/overview/resources-in-the-rest-api#rate-limiting
	Core *Rate `json:"core"`
	...
	//
	// GitHub API docs: https://docs.github.com/rest/search#rate-limit
	Search *Rate `json:"search"`

	// GitHub API docs: https://docs.github.com/graphql/overview/resource-limitations#rate-limit
	GraphQL *Rate `json:"graphql"`

	// GitHub API dos: https://docs.github.com/rest/rate-limit
