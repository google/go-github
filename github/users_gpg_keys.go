...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#list-gpg-keys-for-a-user
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#list-gpg-keys-for-the-authenticated-user
...
// via Basic Auth or via OAuth with at least read:gpg_key scope.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#get-a-gpg-key-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#create-a-gpg-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/users/gpg_keys/#delete-a-gpg-key-for-the-authenticated-user
