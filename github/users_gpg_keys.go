...
//
// GitHub API docs: https://docs.github.com/en/rest/users/#list-gpg-keys-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/users/#list-gpg-keys-for-a-user
...
// via Basic Auth or via OAuth with at least read:gpg_key scope.
//
// GitHub API docs: https://docs.github.com/en/rest/users/#get-a-gpg-key-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/users/#create-a-gpg-key
...
//
// GitHub API docs: https://docs.github.com/en/rest/users/#delete-a-gpg-key-for-the-authenticated-user
