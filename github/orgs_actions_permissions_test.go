...
func TestOrganizationsService_GetActionsPermissions(t *testing.T) {
	...
	want := &ActionsPermissions{EnabledRepositories: "all", AllowedActions: new("all")}
...
func TestOrganizationsService_UpdateActionsPermissions(t *testing.T) {
	...
	input := &ActionsPermissions{EnabledRepositories: "all", AllowedActions: new("selected")}
	...
	want := &ActionsPermissions{EnabledRepositories: "all", AllowedActions: new("selected")}
	if !cmp.Equal(org, want) {
