...
func TestAgentTasksService_ListIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.AgentTasks.ListIter(t.Context(), nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.AgentTasks.ListIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &AgentTaskListOptions{}
	iter = client.AgentTasks.ListIter(t.Context(), opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.AgentTasks.ListIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.AgentTasks.ListIter call 3 got %v items; want 1 (an error)", gotItems)
	}

	iter = client.AgentTasks.ListIter(t.Context(), nil)
	gotItems = 0
	iter(func(item *AgentTask, err error) bool {
		gotItems++
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
		}
	...
	if gotItems != 1 {
		t.Errorf("client.AgentTasks.ListIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}

func TestAgentTasksService_ListByRepoIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.AgentTasks.ListByRepoIter(t.Context(), "", "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.AgentTasks.ListByRepoIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &AgentTaskListByRepoOptions{}
	iter = client.AgentTasks.ListByRepoIter(t.Context(), "", "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.AgentTasks.ListByRepoIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.AgentTasks.ListByRepoIter call 3 got %v items; want 1 (an error)", gotItems)
	}
...
func TestEnterpriseService_ListUserStatesForBudgetIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.Enterprise.ListUserStatesForBudgetIter(t.Context(), "", "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.Enterprise.ListUserStatesForBudgetIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &EnterpriseGetUserStatesOptions{}
	iter = client.Enterprise.ListUserStatesForBudgetIter(t.Context(), "", "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.Enterprise.ListUserStatesForBudgetIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Enterprise.ListUserStatesForBudgetIter call 3 got %v items; want 1 (an error)", gotItems)
	}

	iter = client.Enterprise.ListUserStatesForBudgetIter(t.Context(), "", "", nil)
	gotItems = 0
	iter(func(item *EnterpriseBudgetUserState, err error) bool {
		gotItems++
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
		}
	...
	if gotItems != 1 {
		t.Errorf("client.Enterprise.ListUserStatesForBudgetIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}
...
func TestEnterpriseService_ListBudgetsIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.Enterprise.ListBudgetsIter(t.Context(), "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.Enterprise.ListBudgetsIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Enterprise.ListBudgetsIter call 3 got %v items; want 1 (an error)", gotItems)
	}

	iter = client.Enterprise.ListBudgetsIter(t.Context(), "", nil)
	gotItems = 0
	iter(func(item *EnterpriseBudget, err error) bool {
		gotItems++
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
		}
	...
	if gotItems != 1 {
		t.Errorf("client.Enterprise.ListBudgetsIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}
...
func TestEnterpriseService_ListConsumedLicensesIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.Enterprise.ListConsumedLicensesIter(t.Context(), "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.Enterprise.ListConsumedLicensesIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &ListOptions{}
	iter = client.Enterprise.ListConsumedLicensesIter(t.Context(), "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.Enterprise.ListConsumedLicensesIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Enterprise.ListConsumedLicensesIter call 3 got %v items; want 1 (an error)", gotItems)
	}

	iter = client.Enterprise.ListConsumedLicensesIter(t.Context(), "", nil)
	gotItems = 0
	iter(func(item *EnterpriseLicensedUsers, err error) bool {
		gotItems++
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
		}
	...
	if gotItems != 1 {
		t.Errorf("client.Enterprise.ListConsumedLicensesIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}
...
func TestOrganizationsService_ListAllRepositoryRulesetsIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.Organizations.ListAllRepositoryRulesetsIter(t.Context(), "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.Organizations.ListAllRepositoryRulesetsIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &ListOptions{}
	iter = client.Organizations.ListAllRepositoryRulesetsIter(t.Context(), "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.Organizations.ListAllRepositoryRulesetsIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Organizations.ListAllRepositoryRulesetsIter call 3 got %v items; want 1 (an error)", gotItems)
	}

	iter = client.Organizations.ListAllRepositoryRulesetsIter(t.Context(), "", nil)
	gotItems = 0
	iter(func(item *RepositoryRuleset, err error) bool {
		gotItems++
		if err != nil {
			t.Errorf("Unexpected error: %v", err)
		}
	...
	if gotItems != 1 {
		t.Errorf("client.Organizations.ListAllRepositoryRulesetsIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}
...
func TestPullRequestsService_ListStacksIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.PullRequests.ListStacksIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &PullRequestListStacksOptions{}
	iter = client.PullRequests.ListStacksIter(t.Context(), "", "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.PullRequests.ListStacksIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.PullRequests.ListStacksIter call 3 got %v items; want 1 (an error)", gotItems)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.PullRequests.ListStacksIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}
...
func TestRepositoriesService_ListCommitComparisonFilesIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.Repositories.ListCommitComparisonFilesIter(t.Context(), "", "", "", "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.Repositories.ListCommitComparisonFilesIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &ListOptions{}
	iter = client.Repositories.ListCommitComparisonFilesIter(t.Context(), "", "", "", "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.Repositories.ListCommitComparisonFilesIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Repositories.ListCommitComparisonFilesIter call 3 got %v items; want 1 (an error)", gotItems)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Repositories.ListCommitComparisonFilesIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}

func TestRepositoriesService_ListCombinedStatusIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.Repositories.ListCombinedStatusIter(t.Context(), "", "", "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.Repositories.ListCombinedStatusIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &ListOptions{}
	iter = client.Repositories.ListCombinedStatusIter(t.Context(), "", "", "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.Repositories.ListCombinedStatusIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Repositories.ListCombinedStatusIter call 3 got %v items; want 1 (an error)", gotItems)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Repositories.ListCombinedStatusIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}

func TestRepositoriesService_ListCommitFilesIter(t *testing.T) {
	t.Parallel()
	client, mux, _ := setup(t)
	var callNum int
	mux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
	...
	iter := client.Repositories.ListCommitFilesIter(t.Context(), "", "", "", nil)
	var gotItems int
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 7; gotItems != want {
		t.Errorf("client.Repositories.ListCommitFilesIter call 1 got %v items; want %v", gotItems, want)
	}

	opts := &ListOptions{}
	iter = client.Repositories.ListCommitFilesIter(t.Context(), "", "", "", opts)
	gotItems = 0
	for _, err := range iter {
		gotItems++
		if err != nil {
	...
	if want := 2; gotItems != want {
		t.Errorf("client.Repositories.ListCommitFilesIter call 2 got %v items; want %v", gotItems, want)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Repositories.ListCommitFilesIter call 3 got %v items; want 1 (an error)", gotItems)
	}
	...
	if gotItems != 1 {
		t.Errorf("client.Repositories.ListCommitFilesIter call 4 got %v items; want 1 (an error)", gotItems)
	}
}
