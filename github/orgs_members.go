...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#list-organization-members
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#list-public-organization-members
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#check-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#check-public-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#remove-an-organization-member
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#set-public-organization-membership-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#remove-public-organization-membership-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#list-organization-memberships-for-the-authenticated-user
...
// authenticated user.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#get-an-organization-membership-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#get-organization-membership-for-a-user
...
// authenticated user.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#update-an-organization-membership-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#set-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#remove-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#list-pending-organization-invitations
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#create-an-organization-invitation
...
// the authenticated user must be an organization owner.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/members/#list-organization-invitation-teams
