...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#list-organization-members
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#list-public-organization-members
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#check-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#check-public-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#remove-an-organization-member
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#set-public-organization-membership-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#remove-public-organization-membership-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#list-organization-memberships-for-the-authenticated-user
...
// authenticated user.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#get-an-organization-membership-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#get-organization-membership-for-a-user
...
// authenticated user.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#update-an-organization-membership-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#set-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#remove-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#list-pending-organization-invitations
...
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#create-an-organization-invitation
...
// the authenticated user must be an organization owner.
//
// GitHub API docs: https://docs.github.com/en/rest/reference/orgs/#list-organization-invitation-teams
