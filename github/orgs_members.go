...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#list-organization-members
// GitHub API docs: https://docs.github.com/en/rest/orgs/#list-public-organization-members
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#check-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#check-public-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#remove-an-organization-member
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#set-public-organization-membership-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#remove-public-organization-membership-for-the-authenticated-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#list-organization-memberships-for-the-authenticated-user
...
// authenticated user.
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#get-an-organization-membership-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/orgs/#get-organization-membership-for-a-user
...
// authenticated user.
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#update-an-organization-membership-for-the-authenticated-user
// GitHub API docs: https://docs.github.com/en/rest/orgs/#set-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#remove-organization-membership-for-a-user
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#list-pending-organization-invitations
...
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#create-an-organization-invitation
...
// the authenticated user must be an organization owner.
//
// GitHub API docs: https://docs.github.com/en/rest/orgs/#list-organization-invitation-teams
