...
[![GoDoc](https://img.shields.io/static/v1?label=godoc&message=reference&color=blue)](https://pkg.go.dev/github.com/google/go-github/v58/github)
...
```bash
go get github.com/google/go-github/v58@master
```

## Usage ##

```go
import "github.com/google/go-github/v58/github"	// with go modules enabled (GO111MODULE=on or outside GOPATH)
...
[package docs]: https://pkg.go.dev/github.com/google/go-github/v58/github
