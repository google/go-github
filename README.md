...
```bash
go get github.com/google/go-github/v56@master
```

## Usage ##

```go
import "github.com/google/go-github/v56/github"	// with go modules enabled (GO111MODULE=on or outside GOPATH)
...
[package docs]: https://pkg.go.dev/github.com/google/go-github/v56/github
