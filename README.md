...
[![GoDoc](https://img.shields.io/static/v1?label=godoc&message=reference&color=blue)](https://pkg.go.dev/github.com/google/go-github/v53/github)
...
```bash
go get github.com/google/go-github/v53@master
```
...
[package docs]: https://pkg.go.dev/github.com/google/go-github/v53/github
